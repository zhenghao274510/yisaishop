			...
			<view>
				<view class="city-list-container">
					...
					<view class="city-list-content" id="location_city">
						...
						<view class="city-list city-list-inline d-items-center uni-flex">
							<view class="location-city" @tap="selectedCity(locationCity)">{{locationCity}}</view>
							<view class="uni-flex d-items-center" style="margin: 30upx 0 0 20upx;" @tap="getUserLocation">
	...
	export default {
		...
		methods: {
			...
			getUserLocation() {
				...
				// #ifdef MP-WEIXIN 
				this.$api.getLocation(options => {
					this.$api.localEncal(options, (res) => {
