			...
			<view class="sku-content">
				<view class="a-t">
					...
					<view class="right">
						<text class="guge-price">
							...
							<text style="font-size: 30upx;color: #ff0000;">{{ currentGroup.price | parsePrice}}</text>
						</text>
						<view class="selected">
							已选：
							<text class="selected-text">{{ currentGroup.number }}人团</text>
						</view>
					</view>
				...
				<view class="attr-list">
					<view class="item-list">
						<text v-for="(v, k) in dataobject.setList" :key="k" class="tit" :class="{selected:active==k}" @click.stop="choseSku(v,k)">
							{{ v.number }}人团</text>
					</view>
				</view>
			</view>
